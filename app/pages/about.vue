<template>
	<UiContainer>
		<AppPage title="¿Por qué aparecio Sucugrafia?">
			<p class="mt-2">
				...
				accusamus aut perspiciatis dignissimos facilis error explicabo id aliquam ut ratione, dolore sed amet
				eos! Perspiciatis nostrum numquam mollitia eum reprehenderit quae doloribus beatae temporibus neque
				dolorum quasi unde, quisquam nam sapiente distinctio magnam voluptatibus facere cumque molestias porro.
				Est asperiores iusto, excepturi distinctio ullam quas culpa explicabo quod nisi accusamus tempora velit
				vel dolorem?
			</p>
		</AppPage>
	</UiContainer>
