/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 16a24f5e7f3a273adbc9909aa2e993fe)
// Runtime types generated with workerd@1.20251210.0 2025-11-13
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.output/server/index");
	}
	interface Env {
		NUXT_CLOUDINARY_CLOUD_NAME: string;
		NUXT_CLOUDINARY_API_KEY: string;
		NUXT_CLOUDINARY_API_SECRET: string;
		ASSETS: Fetcher;
	}
}
